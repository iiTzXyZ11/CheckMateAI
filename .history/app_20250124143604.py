...
def grade_essay(essay_text, context_text):
    ...
    try:
        ...
        grade_pattern = re.compile(r"Grade:\s*[\*\_]*([\d\.]+)\s*/\s*[\*\_]*([\d\.]+)")  # Allow extra symbols like * or _ around grade
        ...
        for criterion in criteria:
            ...
            try:
                ...
                # Extract grade details using regex
                ...
                total_points = int(grade_match.group(2))
