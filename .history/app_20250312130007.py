        ...
        response = client.chat.completions.create(
            ...
            messages=[{
                ...
                "content": (
                    ...
                    "Do not be overly lenient but also avoid being too strict. Consider and refer to the context and parameters provided by the teacher. "
                    "Respond in Filipino and provide a correct grade if the essay meets the criteria. "
