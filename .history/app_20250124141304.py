...
def grade_essay(essay_text, context_text):
    ...
    try:
        ...
        ai_feedback = (
            "Clarity: 18/20 - Well-articulated but some sentences are verbose.\n"
            "Relevance: 25/30 - Mostly on-topic, with minor digressions.\n"
            "Creativity: 15/20 - Original ideas but needs more depth."
        )
        ...
        for criterion in criteria:
            ...
            if match:
                ...
                logger.warning(f"Feedback for criterion '{criterion['name']}' not found in AI response.")
