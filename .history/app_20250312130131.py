        ...
        response = client.chat.completions.create(
            ...
            messages=[{
                ...
                "content": (
                    ...
                    "Respond in Filipino with a fair assessment. Only assign a failing grade if the student work shows no clear connection to the required topic or criterion.\n\n"
                    f"Essay to grade: {truncated_essay}\n\n"
                    "Your response should follow this format:\n"
                    f"Grade: [numeric value]/{criterion['points_possible']}\n"
                    "Justification: [Provide specific examples from the student's work that justify your grade. Mention both positive aspects and areas for improvement.]"
                )
            }]
        )
