...
def index():
    ...
    # Render the form, pre-filling context and essay if available
    return render_template('index.html', context=session.get('context_text', ''))  # ✅ Load saved context@app.route('/process_essay', methods=['POST'])
def process_essay():
    ...
    # Pass the essay and context to the results page for repopulation
