                ...
                response = client.chat.completions.create(
                    ...
                    messages=[{
                        ...
                        "content": (f"Grade the following essay based on the criterion '{criterion['name']}' out of "
                                    ...
                                    "Provide a clear explanation for why you assigned this grade based on the essay's quality "
                                    "and its alignment with the criterion. "
                                    ...
                                    "Please include your reasoning and explanation for assigning this grade.")
                    }]
                )
